$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            ...
            // Event start date
            start: new Date('Aug 14, 2021 14:00'),
            ...
            end: new Date('Aug 15, 2021 03:00'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== '5522e4a56247e6a8e92a946111f09472') {
            ...
            $.post('https://script.google.com/macros/s/AKfycbygB-sfp0HAMr3zgY0mnXroMkPIMDP-FwhbYRilynyD--Rrqzg/exec', data)
                ...
                .fail(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Es gibt momentan Probleme mit dem Server. '));
                });
        }
    });
...
function alert_markup(alert_type, msg) {
    return '<div class="alert alert-' + alert_type + '" role="alert">' + msg + '<button type="button" class="close" data-dismiss="alert" aria-label="Schließen"><span>&times;</span></button></div>';
}
